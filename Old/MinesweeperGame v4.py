...
#NOW GOING TO MESS WITH CLICK EVEN MORE
...
def cascaderight(w,h,x,y,board,revealed):
    ...
    #Right
    revealed[y][x] = True
    if x != w-1 and revealed[y][x+1] != True:
        print "Right"
        x += 1
        displayboard(w,h,board,revealed)
        cascaderight(w,h,x,y,board,revealed)
...
# and not board[y][x] == "[*]" and not str(board[y+1][x])[1].isdigit()

def cascadedown(w,h,x,y,board,revealed):
    #Down
    revealed[y][x] = True
    if y != h-1 and revealed[y+1][x] != True:
        print "Down"
        y += 1
        displayboard(w,h,board,revealed)
        cascadedown(w,h,x,y,board,revealed)
...
def cascadeleft(w,h,x,y,board,revealed):
    #Left
    revealed[y][x] = True
    if x != 0 and revealed[y][x-1] != True:
        print "Left"
        x -= 1
        displayboard(w,h,board,revealed)
        cascadeleft(w,h,x,y,board,revealed)
...
def cascadeup(w,h,x,y,board,revealed):
    #Up
    revealed[y][x] = True
    if y != 0 and revealed[y-1][x] != True:
        print "Up"
        y -= 1
        displayboard(w,h,board,revealed)
        cascadeup(w,h,x,y,board,revealed)
